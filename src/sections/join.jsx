      ...
      <div className="join-container">
        ...
        <div className="join-media-wrap">
          <div className="join-media">
            ...
            ></video>
            <p className="join-p">
              “I love SIPLUSH because I was always struggling finding cute
              shaker — @beatrizpdcosta
            </p>
          </div>
          <div className="join-media">
            <video
            ...
            ></video>
            <p className="join-p">
              “I love SIPLUSH because It’s stylish, functional, and super
              practical. — @soyjuferraz
            </p>
          </div>
          <div className="join-media">
            <video
            ...
            ></video>
            <p className="join-p">
              “I love SIPLUSH because It’s easy to use, and it fits perfectly
              into my routine. — @yrrudyk
            </p>
          </div>
        </div>
      </div>
